package fr.pham.vinh.jenkins.jms.openwire;

import com.google.gson.Gson;
import fr.pham.vinh.jenkins.jms.commons.jms.JenkinsJms;
 ...
 */
public class JenkinsJmsOpenwireLauncher {

    private static final Logger LOGGER = LoggerFactory.getLogger(JenkinsJmsOpenwireLauncher.class);
    ...
    static {
        ...
        try (InputStream in = JenkinsJmsOpenwireLauncher.class.getClassLoader().getResourceAsStream("properties.properties")) {
            properties.load(in);
