 ...
 */
public class SquashJmsOpenwireLauncher extends JmsPull {

    private static final Logger LOGGER = LoggerFactory.getLogger(SquashJmsOpenwireLauncher.class);
     ...
     */
    private SquashJmsOpenwireLauncher(String topic, String user, String password) {
    ...
    static {
        ...
        try (InputStream in = PortailJmsOpenwireLauncher.class.getClassLoader().getResourceAsStream("properties.properties")) {
            properties.load(in);
            topic = DEFAULT_TOPIC;
    ...
    public static void main(String args[]) {
        try (SquashJmsOpenwireLauncher squash = new SquashJmsOpenwireLauncher(topic, user, password)) {
